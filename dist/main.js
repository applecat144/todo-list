...
/* harmony export */ });
/* harmony import */ var _lib_getTimezoneOffsetInMilliseconds_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(15);
/* harmony import */ var _startOfDay_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(13);
...
/* harmony import */ var date_fns_differenceInCalendarDays__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11);
...
class items {
    ...
    getTimeLeft() {
        ...
        if (currDate.getFullYear() === dueDate.getFullYear() && currDate.getMonth() === dueDate.getMonth() && currDate.getDate() === dueDate.getDate()) {
            ...
            return (0,date_fns_differenceInCalendarDays__WEBPACK_IMPORTED_MODULE_1__["default"])(dueDate, currDate);
        }

        console.log(`You have ${(0,date_fns_differenceInCalendarDays__WEBPACK_IMPORTED_MODULE_1__["default"])(dueDate, currDate)} day(s) to complete this task ! You can do it !`);
        return (0,date_fns_differenceInCalendarDays__WEBPACK_IMPORTED_MODULE_1__["default"])(dueDate, currDate);
    }
}
